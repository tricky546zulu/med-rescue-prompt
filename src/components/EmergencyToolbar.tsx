  ...
  const emergencyScenarios = [
    {
      ...
      searchTerms: ["epinephrine", "amiodarone", "atropine", "cardiac arrest"]
    },
    {
      name: "Anaphylaxis",
      icon: AlertTriangle,
      color: "bg-orange-500 hover:bg-orange-600 text-white",
      searchTerms: ["epinephrine", "diphenhydramine", "methylprednisolone", "anaphylaxis"]
    },
    {
      name: "Seizures",
      icon: Zap,
      color: "bg-purple-500 hover:bg-purple-600 text-white",
      searchTerms: ["lorazepam", "diazepam", "phenytoin", "seizure"]
    },
    {
      name: "Shock",
      icon: ShieldAlert,
      color: "bg-red-600 hover:bg-red-700 text-white",
      searchTerms: ["norepinephrine", "dopamine", "dobutamine", "shock"]
    }
  ];
    ...
    <div className={`bg-red-50 border-l-4 border-red-500 p-4 rounded-lg ${className}`}>
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center">
          ...
          <h3 className="font-bold text-red-800">Emergency Quick Access</h3>
        </div>
        ...
        {emergencyScenarios.map((scenario) => {
          ...
          return (
            <Button
              ...
              onClick={() => onScenarioSelect(scenario.searchTerms[0])}
            >
